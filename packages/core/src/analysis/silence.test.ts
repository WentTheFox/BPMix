...
describe('findContentBounds', () => {
  it('trims leading and trailing silence, keeping only the audible middle', () => {
  ...
  it('leaves an already-tight track unchanged', () => {
  ...
  it('falls back to the full range for an entirely silent track instead of an empty one', () => {
  ...
  it('mixes multiple channels down before measuring, not just the first', () => {
